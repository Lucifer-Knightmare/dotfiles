...

{
  ...
  keys = {
    { "<leader>Mi", mode = { "n" }, "<cmd>MoltenInit<cr>", desc = "Initialize Molten", silent = true },
    {
      "<leader>Me",
      mode = { "n" },
    ...
    { "<leader>Ml", mode = { "n" }, "<cmd>MoltenEvaluateLine<cr>", desc = "Evaluate Line", silent = true },
    { "<leader>Mc", mode = { "n" }, "<cmd>MoltenReevaluateCell<cr>", desc = "(Re-)Evaluate Cell", silent = true },
    { "<leader>Mv", mode = { "v" }, "<cmd>MoltenEvaluateVisual<cr>", desc = "Evaluate Selection", silent = true },
    { "<leader>Mr", mode = { "n" }, "<cmd>MoltenDelete<cr>", desc = "Delete Cell", silent = true },
    { "<leader>Mh", mode = { "n" }, "<cmd>MoltenHideOutput<cr>", desc = "Hide Output", silent = true },
    {
      "<leader>Mo",
      mode = { "n" },
...

{
  ...
  keys = {
    { "<leader>qa", ":QuartoActivate<cr>", desc = "quarto activate" },
      ...
      { "<leader>qs", ":QuartoSend<cr>", desc = "quarto run cell"},
